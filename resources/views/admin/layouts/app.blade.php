...
<head>
    ...
    <style>
        body{background:#f5f8fb}.sidebar{min-height:100vh;background:linear-gradient(180deg,#0b4da2,#0a8f5b);color:#fff}.sidebar a{color:#eaf4ff;text-decoration:none;display:block;padding:.7rem .9rem;border-radius:.7rem}.sidebar a:hover{background:rgba(255,255,255,.12)}.card{border:0;border-radius:18px;box-shadow:0 8px 28px rgba(20,50,90,.08)}.admin-brand{text-align:center}.admin-brand img{width:105px;height:105px;object-fit:contain;background:#fff;border-radius:18px;padding:5px;margin-bottom:10px}
    </style>
</head>
<body>
<div class="container-fluid"><div class="row">
    <aside class="col-lg-2 p-3 sidebar">
        <div class="admin-brand"><img src="{{ asset('images/mci-logo.png') }}" alt="MCI Educational Group logo"><h5 class="fw-bold mb-1">MCI ADMIN</h5><small>Educational Group</small></div><hr>
