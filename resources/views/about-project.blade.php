...
<div class="col-lg-5"><div class="v2-section-kicker">About this initiative</div><h2 class="v2-title display-5 mt-2">हम क्या करते हैं</h2><p class="v2-copy">{{ $project['hindi'] }}</p><p class="v2-copy">{{ $project['summary'] }}</p></div>
